...
import './talent_slider.scss'


export default function TalentSlider(){
    return(
        
        <div class="container-lg talent">
            <div class="row">
                <div class="col-sm-12">			
                    <div id="myCarousel" class="carousel slide" data-ride="carousel">
                        <h3>Customer <b>Testimonials</b></h3>
                        {/* <!-- Carousel indicators --> */}
                            ...
                            <div class="carousel-item active">
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="media">
                                            <img src="https://res.cloudinary.com/skiltime/image/upload/v1638331897/nike_kqqshh.jpg" class="mr-3" alt="..." />
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="media">
                                            <div class="media-left d-flex mr-3">
                                                <img src="https://res.cloudinary.com/skiltime/image/upload/v1638331897/nike_kqqshh.jpg" alt="..." />										
                                            </div>
                                            <div class="media-body">
                                                <div class="overview">
