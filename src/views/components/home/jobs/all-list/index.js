                ...
                <div className="tab-content">
                    <div id="tab-1" className="tab-pane fade show p-0 active">
                        <div className="job-item p-4 mb-4">
                            <div className="row g-4">
                                <div className="col-sm-12 col-md-8 d-flex align-items-center">
                                    <img className="flex-shrink-0 img-fluid border rounded" src="../../../../assets/img/com-logo-1.jpg" alt="all-jobs" style={{width: "80px", height: "80px"}} />
                        ...
                        <div className="job-item p-4 mb-4">
                            <div className="row g-4">
                                <div className="col-sm-12 col-md-8 d-flex align-items-center">
                                    <img className="flex-shrink-0 img-fluid border rounded" src="../../../../assets/img/com-logo-2.jpg" alt="all-jobs" style={{width: "80px", height: "80px"}} />
                                    <div className="text-start ps-4">
                        ...
                        <div className="job-item p-4 mb-4">
                            <div className="row g-4">
                                <div className="col-sm-12 col-md-8 d-flex align-items-center">
                                    <img className="flex-shrink-0 img-fluid border rounded" src="../../../../assets/img/com-logo-3.jpg" alt="all-jobs" style={{width: "80px", height: "80px"}} />
                                    <div className="text-start ps-4">
                        ...
                        <div className="job-item p-4 mb-4">
                            <div className="row g-4">
                                <div className="col-sm-12 col-md-8 d-flex align-items-center">
                                    <img className="flex-shrink-0 img-fluid border rounded" src="../../../../assets/img/com-logo-4.jpg" alt="all-jobs" style={{width: "80px", height: "80px"}} />
                                    <div className="text-start ps-4">
                        ...
                        <div className="job-item p-4 mb-4">
                            <div className="row g-4">
                                <div className="col-sm-12 col-md-8 d-flex align-items-center">
                                    <img className="flex-shrink-0 img-fluid border rounded" src="../../../../assets/img/com-logo-5.jpg" alt="all-jobs" style={{width: "80px", height: "80px"}} />
                                    <div className="text-start ps-4">
